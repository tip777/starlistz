...
$user_list = []
30.times do |i|
    $user_list.push("user_genreuser_genreuser_genreuser_genreuser_genreuser_genreuser_genreuser_genreuser_genreuser_gen#{format("%02d", i)}")
end
...
15.times do |i|
  ...
  if i == random.rand(1..15)
    Track.create(list_id: 100, artist: "アーティストアーティストアーティストアーティストアーティストアーティストアーティストアーティスト#{format("%02d", i)}", song: "ソングソングソングソングソングソングソングソングソングソングソングソングソングソングソングソング#{format("%02d", i)}", description: "この曲のバースはハンパじゃない。昔から聞いてるけどバース１のパンチラインが何回聞いても癖になる！この曲のバースはハンパじゃない。昔から聞いてるけどバース１のパンチラインが何回聞いても癖になる！この曲のバースはハンパじゃない。昔から聞いてるけどバース１のパンチラインが何回聞いても癖になる！この曲のバースはハンパじゃない。昔から聞いてるけどバース１のパンチラインが何回聞いても癖になる！この曲のバースはハンパじゃない。昔から聞いてるけどバース１のパンチラインが何回聞いても癖になる！この曲のバースはハンパじゃない。昔から聞いてるけどバース１のパンチラインが何回聞いても癖になる！この曲のバースはハンパじゃない。昔から聞いてるけどバース１のパンチラインが何回聞いても癖になる！この曲のバースはハンパじゃない。昔から聞いてるけどバース１のパンチラインが何回聞いても癖になる！昔から聞いてるけどバース１の#{format("%2d", i)}", recommend: true, row_order: i+1)
  else
    Track.create(list_id: 100, artist: "アーティストアーティストアーティストアーティストアーティストアーティストアーティストアーティスト#{format("%02d", i)}", song: "ソングソングソングソングソングソングソングソングソングソングソングソングソングソングソングソング#{format("%02d", i)}", description: "この曲のバースはハンパじゃない。昔から聞いてるけどバース１のパンチラインが何回聞いても癖になる！この曲のバースはハンパじゃない。昔から聞いてるけどバース１のパンチラインが何回聞いても癖になる！この曲のバースはハンパじゃない。昔から聞いてるけどバース１のパンチラインが何回聞いても癖になる！この曲のバースはハンパじゃない。昔から聞いてるけどバース１のパンチラインが何回聞いても癖になる！この曲のバースはハンパじゃない。昔から聞いてるけどバース１のパンチラインが何回聞いても癖になる！この曲のバースはハンパじゃない。昔から聞いてるけどバース１のパンチラインが何回聞いても癖になる！この曲のバースはハンパじゃない。昔から聞いてるけどバース１のパンチラインが何回聞いても癖になる！この曲のバースはハンパじゃない。昔から聞いてるけどバース１のパンチラインが何回聞いても癖になる！昔から聞いてるけどバース１の#{format("%2d", i)}", recommend: false, row_order: i+1)
  end
end
...
$list_list = []
30.times do |i|
    $list_list.push("list_genrelist_genrelist_genrelist_genrelist_genrelist_genrelist_genrelist_genrelist_genrelist_gen#{format("%02d", i)}")
end
