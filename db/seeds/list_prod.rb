...
5.times do |i|
  10.times do |n|
    ...
    if n == random.rand(1..10)
      ...
      List.create(id: h,user_id: i+1, title: "プレイリスト #{h}", description: "プレイリストの説明 #{h}プレイリストの説明プレイリストの説明プレイリストの説明プレイリストの説明プレイリストの説明プレイリストの説明プレイリストの説明プレイリストの説明プレイリストの説明プレイリストの説明プレイリストの説明プレイリストの説明", price: (n+1) * 100, status: "release")
    end
  end
end
